...
class TestBase(unittest.TestCase):
    ...
    def test_from_json_string(self):
        """tests the from_json_string"""
        rectangle_input = [{'id': 89, 'width': 10, 'height': 4}]
        square_input = [{'id': 89, 'size': 10}]
    ...
    def test_load_from_file(self):
        ...
        for squ in list_squares_output:
            self.assertTrue(type(squ) is Square)
